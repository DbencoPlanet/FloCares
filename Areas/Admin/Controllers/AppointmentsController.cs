...
namespace FloCares.Areas.Admin.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Appointments.Include(a => a.Department).Include(a => a.Doctor);
        ...
        public async Task<IActionResult> Create(Appointment appointment)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "Id", "DeptName", appointment.DepartmentId);
